...
class CharacterMotion:
    ...
    def precompute_mesh_info(self):
        ...
        if self.character.skinned_mesh is not None:
            ...
            gc.collect()
            release_device_memory(self.joints_pos.device)
        ...
        for joint_idx in range(self.skeleton.nbjoints):
            ...
            def set_callback_in_closure(i: int) -> None:
                ...
                def _(_) -> None:
                    ...
                    new_local_rot_mat = torch.tensor(
                        new_local_rot_mat_np,
                        device=new_local_joint_rots.device,
                        dtype=new_local_joint_rots.dtype,
                    )
