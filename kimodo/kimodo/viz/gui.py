...
class GuiElements:
    ...
    gui_t800_robot_checkbox: viser.GuiCheckboxHandle
    gui_t800_skin_dropdown: viser.GuiInputHandle[str]
    gui_t800_preload_markdown: viser.GuiInputHandle
    gui_t800_quality_button: viser.GuiInputHandle
    gui_t800_quality_markdown: viser.GuiInputHandle
    gui_t800_export_pkl_button: viser.GuiInputHandle
